...
public abstract class AbstractClient implements ActiveMQClient {
	...
	public AbstractClient(ActiveMQContext context) {
		...
		String cmClass = context.getConfig().get("activemq.connection.manager.class");
		CheckUtils.checkNotNull(cmClass, "activemq.connection.manager.class is NOT set!");
